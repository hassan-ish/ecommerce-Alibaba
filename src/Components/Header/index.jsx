...
import { HederWrapper } from "./style";
const Header = (props) => {
          ...
          <div>
            ...
            >
              <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M12 12C14.7625 12 17 9.7625 17 7C17 4.2375 14.7625 2 12 2C9.2375 2 7 4.2375 7 7C7 9.7625 9.2375 12 12 12ZM12 13.5C8.6625 13.5 2 15.175 2 18.5V19.75C2 20.4375 2.5625 21 3.25 21H20.75C21.4375 21 22 20.4375 22 19.75V18.5C22 15.175 15.3375 13.5 12 13.5Z"
                fill="#8B96A5"
              />
            </svg>
            <div>Profile</div>
          ...
          <div>
            ...
            >
              <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M13.35 20.1302C12.59 20.8202 11.42 20.8202 10.66 20.1202L10.55 20.0202C5.30003 15.2702 1.87003 12.1602 2.00003 8.28017C2.06003 6.58017 2.93003 4.95017 4.34003 3.99017C6.98003 2.19017 10.24 3.03017 12 5.09017C13.76 3.03017 17.02 2.18017 19.66 3.99017C21.07 4.95017 21.94 6.58017 22 8.28017C22.14 12.1602 18.7 15.2702 13.45 20.0402L13.35 20.1302Z"
                fill="#8B96A5"
              />
            </svg>
            <div>Orders</div>
